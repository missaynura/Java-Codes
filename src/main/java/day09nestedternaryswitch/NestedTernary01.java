...
public class NestedTernary01 {
    public static void main(String[] args) {
        ...
        /*
        type code to check password if it has more than 8 characters, initial should be i
        if not more than 8 initial should be k solve the tas by using nested-ternary
         */
        String pwd = "iwAkr45";
