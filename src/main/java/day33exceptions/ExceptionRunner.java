...
public class ExceptionRunner {
    ...
    /*
            1. To declare your own strict rules on your application, you can create Your own Exception Classes (Custom Exception Classes)
                For example, if using negative values for age is so dangerous, you can create "IllegalAgeException Class" and you can throw 
                IllegalAgeException when the age is negative.
            ...
            5. If you want to create Unchecked Exception extend to RuntimeException class with extend keyword. Use this if you want your 
                app to stop if rule is not met.
     */
