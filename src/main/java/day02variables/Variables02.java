...
public class Variables02 {
    ...
    //2. primitive data type names start with lower cases, non-primitives start with upper cases.
    ...
    // Note: stack memory stored 1. primitive data types and 2. addresses(reference) of non-primitive datat types
    //      heap memory stores non-primitive data types.
    // !!!!!5. non-primitve data types have methods together with values, primitive ones do not have methods, just values.

    public int num = 45;
    public String city = "Miami";

    // Main method works first in an application, like an engine in a car.
    // Every application need a main method, if you do not have main method application cann not run.
