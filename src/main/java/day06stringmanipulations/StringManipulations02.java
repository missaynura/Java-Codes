...
public class StringManipulations02 {
    ...
    public static void main(String[] args) {
        ...
        //Example 2: type code to check if first and the last character are the same in a string
        ...
        //Example 3: type a code to check if a string is an empty string or not
        //   "" == true     " " == false
        String str = "";
        ...
        //Example 4. type code to check if a string is empty of has just a space character
        //  "" == true    "   "  = true
        String st = "    ";
